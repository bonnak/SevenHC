...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/fullwidth/skin.css') }}">
		<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/font-awesome.css') }}">
		<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/owl.carousel.css') }}">
		<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/jquery.fancybox.css') }}">
		<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/styles.css') }}">
		<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/color-cyan.css') }}">
		<link rel="stylesheet" type="text/css" href="{{ asset('assets/tuner/css/styles.css') }}">
		<!--/ styles -->
	...
	<body>
		<div class="page">
			...
			<header class="page-header main-page">
				...
				<section id="logo" class="logo">
					<div>
						<a href="index-2.html"><img src="{{ asset('assets/img/blue/logo.png') }}" width="190" height="50" alt="Clinico"></a>
					</div>
				</section>
				<!--/ logo -->
				
				<!-- main nav -->
				@include('_partials.main_nav')
				<!--/ main nav -->
			...
			<div class="slider-wrapper">
				<section class="slider" id="slider">
					<div class="ls-slide" data-ls="transition2d:9;slidedelay:7000;">					
						<img src="{{ asset('assets/pic/slide-1.jpg') }}" alt="" class="ls-bg">
					...
					<div class="ls-slide" data-ls="transition2d:40;slidedelay:7000;">				
						<img src="{{ asset('assets/pic/slide-2.jpg') }}" alt="" class="ls-bg">
					...
					<div class="ls-slide" data-ls="transition2d:11;slidedelay:7000;">
						<img src="{{ asset('assets/pic/slide-3.jpg') }}" alt="" class="ls-bg">
				...
				<div class="grid-row">
					...
					<section class="widget doctors-carousel doctors">
						...
						<div id="doctors-carousel" class="owl-carousel">
							<div class="item">
								<div class="pic">
									<img src="{{ asset('assets/pic/doctor-1.jpg') }}" width="270" height="270" alt="Dr. Butcher House">
									<div class="links">
										<ul>
							...
							<div class="item">
								<div class="pic">
									<img src="{{ asset('assets/pic/doctor-2.jpg') }}" width="270" height="270" alt="Dr. Brick Wall">
									<div class="links">
										<ul>
											<li><a href="#" class="fa fa-skype"></a></li>
											<li><a href="#" class="fa fa-twitter"></a></li>
							...
							<div class="item">
								<div class="pic">
									<img src="{{ asset('assets/pic/doctor-3.jpg') }}" width="270" height="270" alt="Dr. Sno White">
									<div class="links">
										<ul>
											<li><a href="#" class="fa fa-skype"></a></li>
											<li><a href="#" class="fa fa-twitter"></a></li>
							...
							<div class="item">
								<div class="pic">
									<img src="{{ asset('assets/pic/doctor-4.jpg') }}" width="270" height="270" alt="Dr. Mangle Taleebin">
									<div class="links">
										<ul>
											<li><a href="#" class="fa fa-skype"></a></li>
											<li><a href="#" class="fa fa-twitter"></a></li>
				...
				<div class="grid-row">
					...
					<div class="grid-col grid-col-3">
						...
						<section class="widget-alt recent-posts">
							...
							<ul>
								<li>
									<a href="#"><img src="{{ asset('assets/pic/post/1.png') }}" width="80" height="80" alt=""></a>
									<p><a href="#">New study links lutein with eye health benefits, consectetur adipiscing</a><br>5 months ago</p>
								</li>
								<li>
									<a href="#"><img src="{{ asset('assets/pic/post/2.png') }}" width="80" height="80" alt=""></a>
									<p><a href="#">Pets may reduce risk of heart disease, et congue dolor heart</a><br>8 months ago</p>
								</li>
								<li>
									<a href="#"><img src="{{ asset('assets/pic/post/3.png') }}" width="80" height="80" alt=""></a>
		...
		<script type="text/javascript" src="{{ asset('assets/js/jquery.fancybox-media.js') }}"></script>
	...
	<!-- Superscrollorama -->		
		<script type="text/javascript" src="{{ asset('assets/js/jquery.superscrollorama.js') }}"></script>
		<script type="text/javascript" src="{{ asset('assets/js/TweenMax.min.js') }}"></script>
		<script type="text/javascript" src="{{ asset('assets/js/TimelineMax.min.js') }}"></script>
	<!--/ Superscrollorama -->
	
		<script type="text/javascript" src="{{ asset('assets/js/jquery.ui.core.min.js') }}"></script>
		<script type="text/javascript" src="{{ asset('assets/js/jquery.ui.widget.min.js') }}"></script>
		<script type="text/javascript" src="{{ asset('assets/js/jquery.ui.tabs.min.js') }}"></script>
		<script type="text/javascript" src="{{ asset('assets/js/jquery-ui-tabs-rotate.js') }}"></script>
		<script type="text/javascript" src="{{ asset('assets/js/jquery.ui.accordion.min.js') }}"></script>
